...
Lack of access to health personnel is a known obstacle to ensuring good health outcomes, especially in poorer countries. That’s because the number of medical professionals is only one part of the healthcare equation– in developed countries, factors like advanced medical technologies and organized healthcare administration can expand the reach of existing health personnel. However, this is not the case in developing countries.
Though the proportion of medical staff may not tell us as much about the state of healthcare in developed countries, it’s a strong indicator of health outcomes in underdeveloped countries– places that are much more susceptible to climate-change induced strain. The decrease of the global medical staff ratio signals an important consideration about the resiliency of our healthcare systems. As the world faces increasingly severe climate impacts, we have to consider what a decrease of medical staff means for the populations who are most vulnerable.
...
There are multiple dimensions to examining the impact of global climate change. Even focusing within the health sector, there are many interwoven factors that exacerbate and compound upon each other to make specific populations most vulnerable. 
...
When we think about ways to examine and tackle global issues like climate change, we can use specific indicators and to identify the regions with most high risk, the specific reasons contributing to that vulnerability, and from there, develop specific, nuanced strategies to tackle those risks.
